...
def ingest(
    ...
    *,
    ...
    for raw_batch in iter_batches(source, batch_size=batch_size, max_records=max_records, collection=collection):
...
if __name__ == "__main__":
    ...
    print(json.dumps(ingest(args.source, batch_size=args.batch_size, max_records=args.max_records, collection=args.collection), indent=2))
